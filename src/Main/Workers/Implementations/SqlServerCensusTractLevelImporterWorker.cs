...
{
    public class SqlServerCensusTractLevelImporterWorker : AbstractCensusTractLevelImporterWorker
    {
        #region Properties

        #endregion

        public SqlServerCensusTractLevelImporterWorker() : base() { }

        public SqlServerCensusTractLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
