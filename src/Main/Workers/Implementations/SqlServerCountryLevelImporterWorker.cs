...
{
    public class SqlServerCountryLevelImporterWorker : AbstractCountryLevelImporterWorker
    {
        #region Properties

        #endregion

        public SqlServerCountryLevelImporterWorker() : base() { }

        public SqlServerCountryLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
